                ...
                <div className="relative w-full max-w-md">
                  ...
                  <div className="relative bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="h-8 flex items-center justify-center">
                        <svg className="w-6 h-6 text-pink-500 animate-reverse-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path>
                        </svg>
                      </div>
                      <div className="p-3 bg-pink-50 dark:bg-pink-900/30 rounded-lg border border-pink-100 dark:border-pink-800/20 shadow-md">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 w-10 h-10 bg-pink-200/50 dark:bg-pink-700/30 rounded-full flex items-center justify-center text-pink-500 dark:text-pink-300 font-bold shadow-sm">I</div>
                          <div className="ml-3">
                            <div className="text-sm font-bold text-pink-600 dark:text-pink-300">Инвестор</div>
                            <div className="text-xs font-medium text-pink-500 dark:text-pink-200">Ищет перспективные проекты</div>
                          </div>
                        </div>
                      </div>
                    </div>
