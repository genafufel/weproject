              ...
              <div className="order-2 md:order-1">
                ...
                <div className="mt-6 prose prose-lg dark:prose-invert">
                  ...
                  >
                    ...
                    >
                      <span className="font-bold">Для студентов и специалистов без опыта</span> — возможность получить реальный опыт работы, создать портфолио и развить навыки в реальных проектах.
                    </motion.li>
                    <motion.li 
                      className="dark:text-gray-300"
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <span className="font-bold">Для стартапов и проектов с ограниченным бюджетом</span> — возможность найти талантливых сотрудников и собрать команду единомышленников для реализации идей.
                    </motion.li>
                    <motion.li 
                      className="dark:text-gray-300"
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <span className="font-bold">Для инвесторов и бизнес-ангелов</span> — возможность находить перспективные проекты на ранних стадиях развития и оказывать финансовую поддержку на выгодных условиях.
                    </motion.li>
                  </motion.ul>
                  <motion.p 
                    className="dark:text-gray-300"
                  ...
                  >
                    <span className="font-bold">Мы верим</span>, что каждый начинающий специалист заслуживает шанса проявить себя, инновационные проекты должны находить свою команду и инвестиции, а инвесторы — достойные проекты. <span className="font-bold">Наша задача</span> — создать экосистему, где талант, идеи и капитал встречаются для успешного сотрудничества.
                  </motion.p>
                </div>
                <div className="mt-8">
                  ...
                  <Link href="/talent" className="ml-4 inline-flex items-center justify-center px-6 py-3 border-2 border-primary dark:border-primary rounded-md text-primary bg-primary/10 hover:bg-primary/20 text-base font-bold tracking-wide shadow-md hover:shadow-lg transition-all dark:text-white">
                    Найти таланты
                  </Link>
                </div>
              </div>
