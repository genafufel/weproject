                ...
                <div className="relative w-full max-w-md">
                  ...
                  <div className="relative bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-3 bg-[#F3E5F5] dark:bg-[#4a1e68]/20 rounded-lg border border-purple-100/80 dark:border-[#9C27B0]/20 shadow-md">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 w-10 h-10 bg-[#E9D4ED] dark:bg-[#9C27B0]/30 rounded-full flex items-center justify-center text-[#9C27B0] dark:text-purple-200 font-bold shadow-sm">I</div>
                          <div className="ml-3">
                            <div className="text-sm font-bold text-[#9C27B0] dark:text-purple-300">Инвестор</div>
                            <div className="text-xs font-medium text-[#AB47BC] dark:text-purple-200">Ищет перспективные проекты</div>
                          </div>
                        </div>
                      </div>
                    </div>
