            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="order-2 md:order-1">
                ...
                <div className="mt-8">
                  ...
                  <Link href="/talent" className="ml-4 inline-flex items-center justify-center px-6 py-3 border-2 border-primary dark:border-primary rounded-md text-white bg-primary/10 hover:bg-primary/20 text-base font-bold tracking-wide shadow-md hover:shadow-lg transition-all dark:text-white">
                    Найти таланты
                  </Link>
                </div>
              </div>
